...
//		analogWrite(pwm,0);
	...
	if(pwmMotor1 > 0)
	{
		...
		analogWrite(pwm,pwmMotor1);
	}
	else if(pwmMotor1 < 0)
	{
		digitalWrite(direction1,LOW);
		digitalWrite(direction2,HIGH);
		analogWrite(pwm,-pwmMotor1);  //making negative pwm value positive
	}
	else
	{
		digitalWrite(direction1,LOW);
...
//		analogWrite(pwm,0);
	...
	else if(pwmMotor2 < 0)
	{
		...
		digitalWrite(direction1,LOW);
		digitalWrite(direction2,HIGH);
		analogWrite(pwm,-pwmMotor2);  //making negative pwm value positive
	}
	else
	{
		digitalWrite(direction1,LOW);
